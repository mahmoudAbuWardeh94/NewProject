package com.summit.expenceInvoice;
...
public class ExpenseInvoiceTC {
	...
	@Test(priority = 1)
	public void TC_1_click_on_finance_at_side_menu() throws InterruptedException {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		expenseInvoice.waitfinanceButton();
		expenseInvoice.financeButton.click();
		js.executeScript("arguments[0].scrollIntoView();", expenseInvoice.financeButton);
	...
	@Test(priority = 4)
	public void click_on_side_arrow() throws InterruptedException {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
	...
	@Test(priority = 5)
	public void click_on_add_new_bill() throws InterruptedException {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
...
//
	...
	public void uploadAttachment() throws AWTException, InterruptedException {
		...
		StringSelection str = new StringSelection("C:\\Users\\DELL\\Desktop\\uploadFile\\Conditional Branching.pdf");
	...
	@Test(priority = 10)
	public void checkTheAmountWithNoTax() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
...
//
	@Test(priority = 12)
	public void checkTheAmountWith10Tax() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
	...
	@Test(priority = 19)
	public void checkTheTotalAmountOnFooter() throws InterruptedException {
	...
	@Test(priority = 20)
	public void checkGSTNumberFromNoTaxField() {
	...
	@Test(priority = 21)
	public void checkGSTNumberFrom10TaxField() {
	...
	@Test(priority = 22)
	public void checkGSTNumberFrom15TaxField() {
	...
	@Test(priority = 23)
	public void checkGSTNumberFrom20TaxField() {
	...
	@Test(priority = 26)
	public void checkApprovedButtonIsNotClickableWhenTheTotalAmountNotEqualAmout() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
	...
	@Test(priority = 27)
	public void checkApprovedButtonIsClickableWhenTotalAmountEqualAmout() throws InterruptedException {
	...
	@Test(priority = 28)
	public void checkClickOnApprovedButton() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
	...
	@Test(priority = 29)
	public void checkClickOnApprovedButtonInPopup() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);
	...
	@Test(priority = 30)
	public void checkTheNumberOfAttchment() {
		ExpenseInvoice expenseInvoice = new ExpenseInvoice(driver);

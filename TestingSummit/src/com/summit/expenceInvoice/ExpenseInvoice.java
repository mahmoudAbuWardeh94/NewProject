...
public class ExpenseInvoice {
	...
	@FindBy(xpath = "(//button[@class='inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground hover:bg-blue-500 self-end bg-[#355DB7] h-10 p-2 w-full disabled:bg-[#6F7D88]'])[1]")
	...
	@FindBy(xpath = "//div[@class='Theme__ErrorMessage-sc-lne9yt-2 jTisFe invalid-feedback']")
